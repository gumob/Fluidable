//
//  FluidTransitionGestureObserver.swift
//  Fluidable
//
...
internal class FluidTransitionGestureObserver: NSObject, FluidGestureObservable {
    /** Type Aliases */
...
extension FluidTransitionGestureObserver {
    func startObserving() {
        ...
        if self.tapGestureRecognizer == nil {
            ...
            self.tapGestureRecognizer?.isEnabled = self.allowDismissWhenTapBackground
        }
