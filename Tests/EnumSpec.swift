...
//                    expect(slideRight.interactionBehavior).to(equal(true))
//                    expect(slideLeft.interactionBehavior).to(equal(true))
//                    expect(slideTop.interactionBehavior).to(equal(true))
//                    expect(slideBottom.interactionBehavior).to(equal(true))
//
//                    expect(drawerRight.interactionBehavior).to(equal(true))
//                    expect(drawerLeft.interactionBehavior).to(equal(true))
//                    expect(drawerTop.interactionBehavior).to(equal(true))
//                    expect(drawerBottom.interactionBehavior).to(equal(true))
